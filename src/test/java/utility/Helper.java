...
public class Helper {
	...
	public static WebDriver startBrowser(String browser, String url) {
		...
		if (browser.equalsIgnoreCase("Chrome") || browser.equalsIgnoreCase("GC")
			...
			System.setProperty("webdriver.chrome.driver", "D:\\SeleniumCompleteProgramm\\PageObjectModelHollandandBarret\\ChromeBrowserJars\\chromedriver.exe");
...
//			System.setProperty("webdriver.gecko.driver", "D:\\SeleniumCompleteProgramm\\MouseHoverInSelenium\\FireFoxDriverJars\\geckodriver.exe");
			...
			System.setProperty("webdriver.edge.driver", "D:\\SeleniumCompleteProgramm\\PageObjectModelHollandandBarret\\EdgeDriverJars\\msedgedriver.exe");
